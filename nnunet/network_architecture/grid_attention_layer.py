...
#            init_weights(m, init_type='kaiming')
    ...
    def _concatenation(self, x, g):
        ...
        phi_g = F.interpolate(self.phi(g), size=theta_x_size[2:], mode=self.interpolate_mode)
        ...
        sigm_psi_f = F.interpolate(sigm_psi_f, size=input_size[2:], mode=self.interpolate_mode)
